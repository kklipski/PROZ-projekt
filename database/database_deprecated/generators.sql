...
TYPE TABSTR3 IS TABLE OF VARCHAR2(35);
TYPE TABSTR4 IS TABLE OF VARCHAR2(35);
TYPE TABSTR5 IS TABLE OF VARCHAR2(45);
...
BEGIN
	...
	genre := TABSTR3('dramat', 'biograficzny, dramat, komedia', 'dramat', 'dramat, gangsterski', 'dramat sądowy', 'dramat, komedia', 'dramat, psychologiczny', 'dramat, gangsterski',
					 'dramat, wojenny', 'fantasy, przygodowy', 'gangsterski', 'dramat, komedia, wojenny', 'kryminał, thriller', 'fantasy, przygodowy', 'thriller, psychologiczny', 
					 'dramat, gangsterski', 'biograficzny, dramat', 'biograficzny, dramat, wojenny', 'surrealistyczny, thriller, sci-fi', 'western', 'thriller', 'animacja, familijny',
					 'dramat, gangsterski', 'dramat', 'dramat, thriller', 'dramat', 'dramat, kryminał', 'dramat, komedia', 'dramat, wojenny', 'dramat historyczny', 
					 'dramat historyczny', 'akcja, sci-fi', 'biograficzny, dramat, wojenny', 'akcja, sci-fi', 'animacja, familijny, przygodowy', 'dramat, wojenny', 
					 'dramat, muzyczny', 'dramat obyczajowy', 'dramat, thriller', 'dramat', 'przygodowy, sci-fi', 'dramat, wojenny', 'przygodowy, sci-fi', 
					 'biograficzny, dramat obyczajowy', 'dramat, gangsterski', 'western', 'dramat', 'melodramat', 'dramat, gangsterski', 'dramat, wojenny');
				 
	director := TABSTR4('Frank Darabont', 'Olivier Nakache, Eric Toledano', 'Frank Darabont', 'Francis Ford Coppola', 'Sidney Lumet', 'Robert Zemeckis', 'Milos Forman', 
						'Francis Ford Coppola', 'Steven Spielberg', 'Peter Jackson', 'Quentin Tarantino', 'Roberto Benigni', 'David Fincher', 'Peter Jackson', 'David Fincher', 
						'Martin Scorsese', 'Ron Howard', 'Roman Polański', 'Christopher Nolan', 'Quentin Tarantino', 'Jonathan Demme', 'Rob Minkoff, Roger Allers', 'Brian De Palma', 
						'Clint Eastwood', 'Martin Scorsese', 'Tony Kaye', 'Luc Besson', 'Peter Farrelly', 'Mark Herman', 'Ridley Scott', 'Mel Gibson', 'Anthony Russo, Joe Russo', 
						'Mel Gibson', 'Anthony Russo, Joe Russo', 'Lee Unkrich, Adrian Molina', 'Steven Spielberg', 'Damien Chazelle', 'Gus Van Sant', 'Christopher Nolan', 
						'Martin Brest', 'Irvin Kershner', 'Francis Ford Coppola', 'Richard Marquand', 'Gabriele Muccino', 'Sergio Leone', 'Sergio Leone', 'Tate Taylor', 
						'Nick Cassavetes', 'Martin Scorsese', 'Oliver Stone');
					
	country := TABSTR5('USA', 'Francja', 'USA', 'USA', 'USA', 'USA', 'USA', 'USA', 'USA', 'Nowa Zelandia, USA', 'USA', 'Włochy', 'USA', 'Nowa Zelandia, USA', 'Niemcy, USA', 'USA',
					   'USA', 'Francja, Niemcy, Polska, Wielka Brytania', 'USA, Wielka Brytania', 'USA', 'USA', 'USA', 'USA', 'Niemcy, USA', 'USA', 'USA', 'Francja', 'USA', 
					   'USA, Wielka Brytania', 'USA, Wielka Brytania', 'USA', 'USA', 'Australia, USA', 'USA', 'USA', 'USA', 'USA', 'USA', 'USA, Wielka Brytania', 'USA', 'USA', 'USA',
					   'USA', 'USA', 'USA, Włochy', 'Hiszpania, Włochy, RFN', 'Indie, USA, Zjednoczone Emiraty Arabskie', 'USA', 'Francja, USA', 'USA, Wielka Brytania');
				   
	total_num := title_pl.count;

	FOR i IN 1..total_num LOOP

		INSERT INTO FILMY_DVD (polski_tytuł_filmu, oryginalny_tytuł_filmu, rok_produkcji, gatunek_filmu, reżyser, kraj produkcji)
			VALUES (title_pl(i), title(i), prod_year(i), genre(i), director(i), country(i));
